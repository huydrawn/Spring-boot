											...
											<tbody>
												<tr
													...
													<td class="content-block"
														...
														valign="top">Hello <strong th:text="#{name}"></strong><br>
												...
												<tr
													...
													<td class="content-block"
														...
														information about our service and it is important that we
														have an accurate email address.</td>
												</tr>
												...
												<tr
													...
													<td class="content-block" itemprop="handler" itemscope=""
														...
														style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
														valign="top"><a th:href="${url}" class="btn-primary"
														itemprop="url"
												...
												<tr
													...
													<td class="content-block"
														...
														valign="top">&copy; 2018 Bootdey</td>
												</tr>
											</tbody>
										</table>
									</td>
